...
import { Container, Heading3, Subtitle } from "./styles";
    ...
    <Container>
      ...
      <div className="container">
        ...
        <div className="content">
          <img src={check} alt="checked" />
          <div>
            <span>Implementação com especialistas</span> focada em planejamento
            e prática (nos planos Marketing Pro e Enterprise)
          </div>
        </div>
        <div className="content ">
          <img src={check} alt="checked" />
          <div>
            <span>Time de especialistas em Sucesso do Cliente</span> para apoiar
            na otimização da estratégia em cada fase da sua jornada (nos planos
